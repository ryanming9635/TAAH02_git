...
// Required Interfance
////////////////////////////////////////////////////////////////////
extern BYTE HDMITX_ReadI2C_Byte(BYTE RegAddr);
extern SYS_STATUS HDMITX_WriteI2C_Byte(BYTE RegAddr,BYTE d);
extern SYS_STATUS HDMITX_ReadI2C_ByteN(BYTE RegAddr,BYTE *pData,int N);
//SYS_STATUS HDMITX_WriteI2C_ByteN(BYTE RegAddr,BYTE *pData,int N);
extern SYS_STATUS HDMITX_SetI2C_Byte(BYTE Reg,BYTE Mask,BYTE Value);
//extern SYS_STATUS HDMITX_ToggleBit(BYTE Reg,BYTE n);
